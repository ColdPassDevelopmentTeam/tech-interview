...
## 🗓️ 스터디 일정 및 진행 방식
### **발표 일정**: 매주 **수요일**, **목요일**
### **정리 자료 제출**: 발표 전일까지 PR 제출
### **발표 자료 제출**: 발표 후 1일 이내 최종 자료 제출
### 진행 방식:
1. **주제 선정** : 스터디원은 매 주 네트워크 관련 개별 주제를 선정
2. **학습 및 자료 정리** : 각자 맡은 주제를 학습, 학습 내용을 Markdown 형식으로 정리
3. **PR** : 정리한 Markdown 문서를 스터디 Git Repository에 PR
4. **발표 자료 제작** : 피드백을 반영하여 발표 자료 제작( Markdown, PDF, PPT 등 )
5. **발표 및 Q&A**
6. **최종 자료 업로드** : 발표가 끝난 후, 최종 발표자료를 PR에 추가
